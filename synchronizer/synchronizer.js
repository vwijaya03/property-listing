...
async function main() {
    try {
        ...
        console.log();
        console.log('isiOptions', process.env.DB_URL, process.env.DB_DATABASE, process.env.COLLECTION_NAME, process.env.DP_CONTRACT_ADDRESS, process.env.DP_ABI_VERSION, process.env.BLOCKCHAIN_PROVIDER_URL);
        console.log();
